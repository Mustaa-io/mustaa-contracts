 ...
 */
interface ILSP7DigitalAssetTime {
    // --- Events
    ...
    /**
     * @dev Get the balance of `tokenOwner` for a specific year.
     * @param tokenOwner The address of the token holder to query the balance for.
     * @param year The year to query the balance for.
     * @return The amount of tokens owned by `tokenOwner` for the specified year.
     */
    function balanceOfYear(address tokenOwner, uint256 year) external view returns (uint256);
